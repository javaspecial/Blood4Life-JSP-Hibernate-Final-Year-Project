        ...
        <script>
            $(document).ready(function () {
                $("#btn_submit").click(function () {
                    ...
                    $.post("DonorSearchtResult.jsp", {ajax_group: group, ajax_district: district}, function (data) {
                        $("#donor_search").html(data);
                    });
                });
            });
        </script>
            ...
            <section class="section-appointment">
                <div class="container wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                    <div class="appointment-form-wrapper text-center clearfix">
                        <h3 class="join-heading">Search Blood Donor</h3>
                        ...
                        <div class="appoinment-form" name="from" id="form"> 
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                <button id="btn_submit" class="btn-submit" style="color: black;">Search Donor</button><br>
                            </div>
                        </div>
                        <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 5px;overflow: auto;">
                            <strong><span id="donor_search" /></strong>
                        </div>
