        ...
        <script>
            $(document).ready(function () {
                $("#submit_update_profile").click(function () {
                    ...
                    $.post("updateMeberProfileAction.jsp", {txtFullName: txtFullName, country: country, division: division, district: district, mobile: mobile, mail: mail, ajaxaddress: addres}, function (data) {
                        $("#messag").html(data);
                    });
                });
            });
    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                ResultSet rs = statement.executeQuery("SELECT * FROM registrationtable WHERE memberusername = '" + username + "'");
                while (rs.next()) {
