        ...
        <%
            ...
            if (name.equals("") || country.equals("") || division.equals("") || district.equals("") || mail.equals("") || mobile.equals("") || address.equals("")) {
                ...
                try {
                    ...
                    String sql = "UPDATE registrationtable SET txtFullName = ?,dpCountry = ?,dpState = ?,dpDistrict =? ,txtMobileNumber = ?,txtPermentAddress = ?, txtEmailId = ? WHERE memberusername = ? ";
