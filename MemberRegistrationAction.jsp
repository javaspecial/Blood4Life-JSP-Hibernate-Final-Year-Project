...
//            });
    ...
    <body style=""> 
        ...
        <%
            ...
            String selectBloodGroup = request.getParameter("dpBloodGroup");
            String selectGender = request.getParameter("dpGender");

            String myDate = request.getParameter("datepicker");

            String mobileNumber = request.getParameter("txtMobileNumber");
            String selectCountry = request.getParameter("dpCountry");
            String selectDivision = request.getParameter("dpState");
            String selectDistrict = request.getParameter("dpDistrict");

            String txtEmailId = request.getParameter("txtEmailId");

            String textAriaPAddress = request.getParameter("txtPermentAddress");
            ...
            try {
                ...
                Connection conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/blood4life", "root", "root");
                Statement st = (Statement) conn.createStatement();
                ResultSet rs = st.executeQuery("SELECT * FROM registrationtable WHERE memberusername = '" + userName + "' ");
                while (rs.next()) {
        %>
        <script>
            swal({
                title: 'Username Already Exist',
                text: 'Pease try with another.....',
                timer: 3000
            }, function () {
        ...
        <%
            ...
            inserted = st.executeUpdate("insert into registrationtable(txtFullName,dpBloodGroup,dpGender,txtDOB,txtMobileNumber,dpCountry,dpState,dpDistrict,txtEmailId,txtPermentAddress,memberusername,password) values('" + fullName + "','" + selectBloodGroup + "','" + selectGender + "','" + myDate + "','" + mobileNumber + "','" + selectCountry + "','" + selectDivision + "','" + selectDistrict + "','" + txtEmailId + "','" + textAriaPAddress + "','" + userName + "','" + password + "')");
            if (inserted == 0) {
        %>
        <script>
            swal({
                title: 'Server busy',
                text: 'Pease try later..........',
                timer: 1000
            }, function () {
                window.location.href = 'MemberLogin.jsp';
            }).then(
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-12">
                            ...
                            <p>Welcome to Blood 4 Life Service &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="loginspan_id" style="margin-left: 30px;color: yellow;"/></p>                                                                
                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="top-bar-social">
                                            <input style="height: 30px;" value=""id="memberusername" name="memberusername" class="form-control"placeholder="Enter User Name" type="text"><br>
                                        </div> 
                                    </td>
                                    <td>
                                        <div class="top-bar-social">
                                            <input style="height: 30px;" value="" id="showpassword" class="form-control" placeholder="Enter Password" type="password">
                                        </div> 
                                    </td>
                                    <td>
                                        <div class="top-bar-social">
                                            <button style="margin-top: 0px;" id="submit" class="">Login</button>
                                        </div>
                                    </td>
                                </tr>
                            </table>
